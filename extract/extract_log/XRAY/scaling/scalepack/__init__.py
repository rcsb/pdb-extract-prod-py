...
# =============================================================================
"""
Extract scaling statistics from Scalepack log file
"""
import logging
...
def run(filepath):
    ...
    logging.info("Scalepack version: %s" % version)
...
def main():
    filepath = "/Users/chenghua/Projects/pdb_extract/tests/test_data/PDB_Template_Scalepack_1/scalepack.log"
    d_ = run(filepath)
